            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <?php 
                        ...
                        // $un=$_GET['username'];
                        $sqlquery="select * from dregistration where usname ='$un'";
                        ...
                        if(isset($_POST['update'])){
                            ...
                            if($fname == "" || $email== "" || $mob=="" || $address=="" || $pass==""){
                                $passmsg='<div class="alert alert-danger col-md-12 text-center" role="alert">Fields cannot be empty</div>';
                            }
                            else{
                                $updatequery="update dregistration set fname='$fname',email='$email', mobile='$mob', gender='$gender', address='$address', password='$$passwrd' where usname= '$formupdate'";
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="form-group">
                                <input class="form-control" type="password" name="pass" value="<?php echo $r_pass?>"required>
                            </div>
                        </div>
                    </div>
                    <div class="row mt-2">
