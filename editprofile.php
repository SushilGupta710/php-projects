            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <?php 
                        ...
                        // $un=$_GET['username'];
                        $sqlquery="select * from registration where usname ='$un'";
                        ...
                        if(isset($_POST['update'])){
                            ...
                            if($fname == "" || $email== "" || $mob=="" || $pass==""){
                                $passmsg='<div class="alert alert-danger col-md-12 text-center" role="alert">Fields cannot be empty</div>';
                            }
                            else{
                                
                                $updatequery="update registration set fname='$fname',email='$email', mob='$mob', passwd='$passwrd' where usname= '$formupdate'";
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="form-group">
                                <input class="form-control" type="password" name="pass" id="pass" value="<?php echo $r_pass?>">
