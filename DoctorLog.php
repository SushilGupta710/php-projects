        ...
        <div class="col-sm-6 col-md-5 col-lg-5 col-xl-4 mx-auto">
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        <div class="col">
                        <center> <img width="80px" src="./Icons/doctorlog.png" alt=""></center>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col">
                    ...
                    <?php 
                        include 'DBcon.php';
                                if(isset($_POST['submit'])){
                                    ...
                                    $qureysearch="select * from dregistration where usname='$username'";
                                    //SQL query to search
                                    ...
                                    if($user_count_row){
                                        ...
                                        $fet_passwd=$datafetch['password'];
                                        
                                        //to fetch the data
                                        //storing fname in session
                                        $_SESSION['doctname']= $datafetch['fname'];//way 1
                                        ...
                                        if($pass_decode){
                                            ...
                                            $passmsg='<div class="alert alert-danger col-md-12 text-center" role="alert">Invalid Password</div>';
                                        }
                                    }else{
                                        $passmsg='<div class="alert alert-danger col-md-12 text-center" role="alert">Invalid Username</div>';
                                    }
                                }   
                    ?>
